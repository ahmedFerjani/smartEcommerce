; (function ($) {
    $.fn.infiniteScroll = function (options) {
        ...
        settings = $.extend({
            ...
            setTimeout(function(){  
                $(".b-infanite-scroll img").removeClass('d-none');
                var content = $(`<span style='opacity:0; display: flex; flex-wrap: wrap;'>${data}</span>`);
                $('.' + settings.markSelector).before(content);
                content.fadeTo(settings.fadeDuration, 1); }, 3000);      
            },
